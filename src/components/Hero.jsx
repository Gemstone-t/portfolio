        ...
        >
          ...
          <div className='head2'>
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hi there, I'm <p className='name text-[#915EFF]'>Justin</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className='absolute link1'>
              <a href='https://github.com/SmileDev10162' target='_blank'>
                <AiOutlineGithub />
              </a>
              <a
                href='https://stackoverflow.com/users/22739879/smile'
                target='_blank'
              >
                <ImStackoverflow />
              </a>
